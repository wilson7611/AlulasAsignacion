        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title mb-0">Lista De Carreras</h5>
                    @if(session('error'))
                        ...
                        <tbody>
                            ...
                            @foreach ($carreras as $carrera)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $carrera->decanaturas->nombre }}</td>
                                    @role('super-admin')
                                        <td>
                                          
                                            <a href="{{route('carreras.edit', $carrera->id)}}"  class="link-warning editIcon"><i
                                                    class="ri-edit-2-fill"></i></a>
                                            <a href="{{route('carreras.show', $carrera->id)}}" class="link-danger"><i class="ri-delete-bin-5-line"></i></a>
                                        </td>
                                    @endrole
                                </tr>
                            @endforeach
