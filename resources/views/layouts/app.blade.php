                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="http://127.0.0.1:8000/assets/images/users/avatar-5.jpg"
                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-1">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <img src="http://127.0.0.1:8000/assets/images/flags/us.svg" class="rounded" alt="Header Language" height="20">
                                        </button>
                    <div class="dropdown-menu dropdown-menu-end">

                        <!-- item-->
                        <a href="http://127.0.0.1:8000/index/en" class="dropdown-item notify-item language py-2" data-lang="en"
                            title="English">
                            <img src="http://127.0.0.1:8000/assets/images/flags/us.svg" alt="user-image" class="me-2 rounded" height="20">
                            <span class="align-middle">English</span>
                        </a>

                        <!-- item-->
                        <a href="http://127.0.0.1:8000/index/sp" class="dropdown-item notify-item language" data-lang="sp"
                            title="Spanish">
                            <img src="http://127.0.0.1:8000/assets/images/flags/spain.svg" alt="user-image" class="me-2 rounded" height="20">
                            <span class="align-middle">Española</span>
                        </a>

                        <!-- item-->
                        <a href="http://127.0.0.1:8000/index/gr" class="dropdown-item notify-item language" data-lang="gr"
                            title="German">
                            <img src="http://127.0.0.1:8000/assets/images/flags/germany.svg" alt="user-image" class="me-2 rounded"
                                height="20"> <span class="align-middle">Deutsche</span>
                        </a>

                        <!-- item-->
                        <a href="http://127.0.0.1:8000/index/it" class="dropdown-item notify-item language" data-lang="it"
                            title="Italian">
                            <img src="http://127.0.0.1:8000/assets/images/flags/italy.svg" alt="user-image" class="me-2 rounded" height="20">
                            <span class="align-middle">Italiana</span>
                        </a>

                        <!-- item-->
                        <a href="http://127.0.0.1:8000/index/ru" class="dropdown-item notify-item language" data-lang="ru"
                            title="Russian">
                            <img src="http://127.0.0.1:8000/assets/images/flags/russia.svg" alt="user-image" class="me-2 rounded" height="20">
                            <span class="align-middle">русский</span>
                        </a>

                        <!-- item-->
                        <a href="http://127.0.0.1:8000/index/ch" class="dropdown-item notify-item language" data-lang="ch"
                            title="Chinese">
                            <img src="http://127.0.0.1:8000/assets/images/flags/china.svg" alt="user-image" class="me-2 rounded" height="20">
                            <span class="align-middle">中国人</span>
                        </a>

                        <!-- item-->
                        <a href="http://127.0.0.1:8000/index/fr" class="dropdown-item notify-item language" data-lang="fr"
                            title="French">
                            <img src="http://127.0.0.1:8000/assets/images/flags/french.svg" alt="user-image" class="me-2 rounded" height="20">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        ...
                        <div class="p-2">
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://127.0.0.1:8000/assets/images/brands/github.png" alt="Github">
                                        <span>GitHub</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://127.0.0.1:8000/assets/images/brands/bitbucket.png" alt="bitbucket">
                                        <span>Bitbucket</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://127.0.0.1:8000/assets/images/brands/dribbble.png" alt="dribbble">
                                        <span>Dribbble</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://127.0.0.1:8000/assets/images/brands/dropbox.png" alt="dropbox">
                                        <span>Dropbox</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://127.0.0.1:8000/assets/images/brands/mail_chimp.png" alt="mail_chimp">
                                        <span>Mail Chimp</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://127.0.0.1:8000/assets/images/brands/slack.png" alt="slack">
                                        <span>Slack</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://127.0.0.1:8000/assets/images/products/img-1.png"
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://127.0.0.1:8000/assets/images/products/img-2.png"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://127.0.0.1:8000/assets/images/products/img-3.png"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://127.0.0.1:8000/assets/images/products/img-6.png"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://127.0.0.1:8000/assets/images/products/img-5.png"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="apps-ecommerce-product-details"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('decanaturas.index')}}" class="nav-link">Decanaturas</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('carreras.index')}}" class="nav-link">Carreras</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('semestres.index')}}" class="nav-link">Semestres</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarSignIn">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        {{-- <li class="nav-item">
                                            <a href="" class="nav-link">Form Asignacion</a>
                                        </li> --}}
                                    </ul>
                                </div>
                            </li> 
